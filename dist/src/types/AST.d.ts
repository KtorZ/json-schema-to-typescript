...
export declare type AST = TAny | TArray | TBoolean | TEnum | TInterface | TNamedInterface | TIntersection | TLiteral | TNumber | TBigInt | TNull | TObject | TReference | TString | TTuple | TUnion | TUnknown | TCustomType;
